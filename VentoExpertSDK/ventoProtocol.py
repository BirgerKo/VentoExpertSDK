...
VENTO_EXPERT_A30_W_V2_PARAMETERS = [ON_OFF, SPEED, BOOST_MODE_STATUS, TIMER_MODE, TIMER_COUNTDOWN, HUMIDITY_SENSOR, RELAY_SENSOR, HUMIDITY_THRESHOLD_SETPOINT,
                                    CURRENT_RTC_BATTERY_VOLTAGE, CURRENT_HUMIDITY, CURRENT_REALY_SENSOR_STATE,
                                    MANUAL_SPEED,
                                    FAN1RPM, FAN2RPM, FILTER_TIMER, RESET_FILTER_TIMER, BOST_MODE_DEACTIVATION_SETPOINT, RTC_TIME, RTC_CALENDAR,
                                    WEEKLY_SCHEDULE_MODE, SCHEDULE_SETUP, SEARCH, DEVICE_PASSWORD, MACHINE_HOURS, RESET_ALARMS, READ_ALARM, CLOUD_OPERATION, READ_FIRMWARE_VERSION,
                                    RESTORE_FACTORY_SETTINGS, FILTER_ALARM, WIFI_OPERATION_MODE, WIFI_CLIENT_NAME, WIFI_PASSWORD, WIFI_ENCRYPTION, WIFI_CHANNEL, WIFI_IP_MODE,
                                    ASSIGNED_IP_ADDRESS, ASSIGNED_IP_SUBNET_MASK, ASSIGNED_IP_GATEWAY, APPLY_QUIT_SETUP_MODE, DISCARD_QUIT_SETUP_MODE, CURRENT_IP_ADDRESS,
                                    VENTILATION_MODE, UNIT_TYPE, SC_CHANGE_FUNCTION_NUMBER, SC_PARAMETER_NOT_SUPPORTED, SC_CHANGE_VALUE_SIZE, SC_CHANGE_HIGH_BYTE,
                                    NIGHT_MODE_TIMER_SETPOINT, PARTY_MODE_TIMER_SETPOINT, HUMIDITY_SETPOINT_STATUS]
...
VENTO_EXPERT_A50_1_W_V2_PARAMETERS = [ON_OFF, SPEED, BOOST_MODE_STATUS, TIMER_MODE, TIMER_COUNTDOWN, HUMIDITY_SENSOR, RELAY_SENSOR, ZERO_10V_SENSOR,
                            HUMIDITY_THRESHOLD_SETPOINT, CURRENT_RTC_BATTERY_VOLTAGE, CURRENT_HUMIDITY, CURRENT_ZERO_10V_SENSOR_VALUE, CURRENT_REALY_SENSOR_STATE,
                            MANUAL_SPEED,
                            FAN1RPM, FAN2RPM, FILTER_TIMER, RESET_FILTER_TIMER, BOST_MODE_DEACTIVATION_SETPOINT, RTC_TIME, RTC_CALENDAR,
                            WEEKLY_SCHEDULE_MODE, SCHEDULE_SETUP, SEARCH, DEVICE_PASSWORD, MACHINE_HOURS, RESET_ALARMS, READ_ALARM, CLOUD_OPERATION, READ_FIRMWARE_VERSION,
                            RESTORE_FACTORY_SETTINGS, FILTER_ALARM, WIFI_OPERATION_MODE, WIFI_CLIENT_NAME, WIFI_PASSWORD, WIFI_ENCRYPTION, WIFI_CHANNEL, WIFI_IP_MODE,
                            ASSIGNED_IP_ADDRESS, ASSIGNED_IP_SUBNET_MASK, ASSIGNED_IP_GATEWAY, APPLY_QUIT_SETUP_MODE, DISCARD_QUIT_SETUP_MODE, CURRENT_IP_ADDRESS,
                            VENTILATION_MODE, ZERO_10V_SENSOR_THRESHOLD, UNIT_TYPE, SC_CHANGE_FUNCTION_NUMBER, SC_PARAMETER_NOT_SUPPORTED, SC_CHANGE_VALUE_SIZE, SC_CHANGE_HIGH_BYTE,
...
VENTO_EXPERT_A50_1_W_V3_PARAMETERS = [ON_OFF, SPEED, BOOST_MODE_STATUS, TIMER_MODE, TIMER_COUNTDOWN, HUMIDITY_SENSOR, RELAY_SENSOR, ZERO_10V_SENSOR,
                            HUMIDITY_THRESHOLD_SETPOINT, CURRENT_RTC_BATTERY_VOLTAGE, CURRENT_HUMIDITY, CURRENT_ZERO_10V_SENSOR_VALUE, CURRENT_REALY_SENSOR_STATE,
                            SUPPLY_FAN_SPEED1, EXHAUST_FAN_SPEED1, SUPPLY_FAN_SPEED2, EXHAUST_FAN_SPEED2, SUPPLY_FAN_SPEED3, EXHAUST_FAN_SPEED3, MANUAL_SPEED,
                            FAN1RPM, FAN2RPM, FILTER_REPLACEMENT_TIME, FILTER_TIMER, RESET_FILTER_TIMER, BOST_MODE_DEACTIVATION_SETPOINT, RTC_TIME, RTC_CALENDAR,
                            WEEKLY_SCHEDULE_MODE, SCHEDULE_SETUP, SEARCH, DEVICE_PASSWORD, MACHINE_HOURS, RESET_ALARMS, READ_ALARM, CLOUD_OPERATION, READ_FIRMWARE_VERSION,
                            RESTORE_FACTORY_SETTINGS, FILTER_ALARM, WIFI_OPERATION_MODE, WIFI_CLIENT_NAME, WIFI_PASSWORD, WIFI_ENCRYPTION, WIFI_CHANNEL, WIFI_IP_MODE,
                            ASSIGNED_IP_ADDRESS, ASSIGNED_IP_SUBNET_MASK, ASSIGNED_IP_GATEWAY, APPLY_QUIT_SETUP_MODE, DISCARD_QUIT_SETUP_MODE, CURRENT_IP_ADDRESS,
                            VENTILATION_MODE, ZERO_10V_SENSOR_THRESHOLD, UNIT_TYPE, SC_CHANGE_FUNCTION_NUMBER, SC_PARAMETER_NOT_SUPPORTED, SC_CHANGE_VALUE_SIZE, SC_CHANGE_HIGH_BYTE,
